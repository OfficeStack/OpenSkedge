...
class ScheduleController extends Controller
{
    ...
    public function deleteAction(Request $request, $pid, $spid)
    {
        ...
        if ($form->isValid()) {
            ...
            $em->flush();
            $request->getSession()->getFlashBag()->add('success', 'Schedule deleted successfully.');
        } else {
            $request->getSession()->getFlashBag()->add('error', 'Schedule could not be deleted. If the issue persists, please report it to your friendly sysadmin.');
        }
